...
func (s *SyncloudAuth) GetLDAPUserForMMUser(rctx request.CTX, mmUser *model.User) (*model.User, string, *model.AppError) {
	mlog.Info("GetLDAPUserForMMUser not implemented", mlog.String("mmUser.Username", mmUser.Username))
	return nil, "", model.NewAppError("GetLDAPUserForMMUser", "ldap", nil, "not implemented", http.StatusNotImplemented)
}
...
func (s *SyncloudAuth) StartSynchronizeJob(c request.CTX, waitForJobToFinish bool, reAddRemovedMembers *bool) (*model.Job, *model.AppError) {
